...
class _CheckoutScreenState extends State<CheckoutScreen> {
          ...
          children: [
                          ...
                          children: [
                            ...
                            notifier.value == null
                                ...
                                : Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child:
                                        ValueListenableBuilder<osm.GeoPoint?>(
                    ...
                    children: [
                      ...
                      Consumer<ProfProvider>(
                        builder: (context, professorsProvider, child) {
                          final profsToShow = _filteredProfs.isEmpty
                          ...
                          if (profsToShow.isEmpty) {
                            ...
                            return Column(
                              children: profsToShow.take(3).map((prof) {
                      ...
                      if (_selectedProfs.isNotEmpty) ...[
                        ...
                        Wrap(
                          spacing: 8,
                          children: _selectedProfs.map((prof) {
                            return Chip(
                              avatar: prof.logoUrl != null
                                  ? CircleAvatar(
                                      backgroundImage:
            ...
            Row(
              ...
              children: [
                ...
                Expanded(
                  child: ElevatedButton(
                    onPressed: stepProvider.currentStep < 5
  ...
  void filterProfs() {
    ...
    setState(() {
      ...
      _filteredProfs = _availableProfs.where((prof) {
  ...
  double _calculateRelevanceScore(UserModel prof, String query) {
    ...
    if (email.startsWith(query))
      score += 80;
    else if (email.contains(query)) score += 40;

    if (role.startsWith(query))
      score += 70;
    else if (role.contains(query)) score += 30;
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  readOnly: true,
                  onTap: () async {
                    final initialTime = startTime != null
                        ? TimeOfDay(
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                setState(() {
                  _schedules = Provider.of<CourseProvider>(
                    context,
                    listen: false,
                  ).schedules;
                });
