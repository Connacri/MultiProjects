...
class CalendarStyleUtils {
  ...
  static const EdgeInsets defaultCellPadding =
  ...
  static const EdgeInsets defaultWeekNumberPadding =
    ...
    return CalendarStyle(
      ...
      todayDecoration: todayDecoration ??
          BoxDecoration(
            ...
            shape: cellShape,
            borderRadius:
                cellShape == BoxShape.rectangle ? cellBorderRadius : null,
          ),
  ...
  static BoxDecoration getDefaultWeekNumberDecoration(
    ...
    return BoxDecoration(
      ...
      borderRadius:
          BorderRadius.circular(borderRadius ?? defaultWeekNumberBorderRadius),
    );
  }
