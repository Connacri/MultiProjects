...
class TimeLabels extends StatelessWidget {
  ...
  List<Widget> _buildHourOnlyLabels(
      DateTime now, double hourHeight, ThemeData theme) {
    return List.generate(
      ...
      (index) {
        ...
        final isCurrentHour =
            highlightCurrentHour && now.hour == hour && now.day == time.day;
          ...
          child: SizedBox(
            ...
            child: Padding(
              ...
              child: Align(
                ...
                child: Text(
                  customTimeLabelBuilder?.call(time) ??
  ...
  /// Supports international time formats through customTimeLabelBuilder
  List<Widget> _buildHourAndHalfLabels(
      DateTime now, double hourHeight, ThemeData theme) {
    final labels = <Widget>[];
    ...
    for (var index = 0; index < endHour - startHour; index++) {
      ...
      final isCurrentHour = highlightCurrentHour &&
          now.hour == hour &&
          now.minute < 30 &&
          now.day == hourTime.day;
      final isCurrentHalfHour = highlightCurrentHour &&
          now.hour == hour &&
          now.minute >= 30 &&
          now.day == halfHourTime.day;
        ...
        Positioned(
          ...
          child: Padding(
            ...
            child: Align(
              ...
              child: Text(
                customTimeLabelBuilder?.call(hourTime) ??
        ...
        Positioned(
          ...
          child: Padding(
            ...
            child: Align(
              alignment: Alignment.topLeft,
              child: Text(
                customTimeLabelBuilder?.call(halfHourTime) ??
                    '${halfHourTime.hour.toString().padLeft(2, '0')}:30',
                style: (style ?? theme.textTheme.bodySmall)?.copyWith(
                  color: isCurrentHalfHour
                      ? theme.colorScheme.primary
