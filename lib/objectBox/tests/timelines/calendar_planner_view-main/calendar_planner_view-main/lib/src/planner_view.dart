...
class CalendarPlannerView extends HookWidget {
  ...
  const CalendarPlannerView({
    ...
    this.noEventsLabel = 'No events scheduled',
  });
  ...
  /// Initial selected date for the calendar
  /// If not provided, defaults to current date
  final DateTime? selectedDate;

  /// Custom builder for the list section
  /// Completely replaces the entire timeline view (including time labels and scroll container)
  /// with a custom widget. Receives filtered events for the selected date.
  /// Parameters: context, events for selected date, selected date
  final Widget Function(BuildContext, List<CalendarEvent>, DateTime)?
      listBuilder;

  /// Whether to show list view instead of timeline view
  /// When true, uses listBuilder if provided, otherwise shows a default list
  /// When false, shows the traditional timeline view with time labels
  final bool showListView;

  /// Label for "No events scheduled" in the default list view.
  final String noEventsLabel;

  String _formattedDate(DateTime date) {
    return CalendarDateUtils.formatDate(date,
      ...
      children: [
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              IconButton(
                icon: calendarDatePickerButtonsWidget ??
                    ...
                    builder: (context) => Dialog(
                      ...
                      child: TweenAnimationBuilder<double>(
                        ...
                        child: Container(
                          ...
                          decoration:
                              CalendarStyleUtils.getDefaultCalendarDecoration(
                            theme,
                            backgroundColor: modalBackgroundColor,
                            borderRadius:
                                BorderRadius.circular(modalBorderRadius),
                            ...
                            children: [
                              ...
                              Container(
                                decoration: BoxDecoration(
                                  color: modalHeaderGradient == null
                                      ? modalHeaderColor
                                      : null,
                              ...
                              Padding(
                                ...
                                child: FlexibleDatePicker(
                                  ...
                                  currentMonthContainerColor:
                                      currentMonthContainerColor,
                                  outsideMonthContainerColor:
                                      outsideMonthContainerColor,
                                  disabledContainerColor:
                                      disabledContainerColor,
                                  rangeHighlightColor: rangeHighlightColor,
                                  rangeStartContainerColor:
                                      rangeStartContainerColor,
                                  rangeEndContainerColor:
                                      rangeEndContainerColor,
                                ),
                              ),
                            ],
              ...
              if (titleCalendarWidget != null) titleCalendarWidget!,
              const Spacer(),
              if (enableViewToggle)
                toggleButtonsWidget ??
                    ToggleButtons(
                      isSelected: [
                        ...
                        viewType.value == CalendarViewType.week
                      ],
                      onPressed: (index) {
                        viewType.value = index == 0
                      ...
                      fillColor: toggleColorBackground ??
        ...
        if (datePickerPosition == DatePickerPosition.top)
          FlexibleDatePicker(
            ...
            displayMode: DatePickerDisplayMode.inline,
            calendarView: viewType.value == CalendarViewType.month
            ...
            onCalendarFormatChanged: (format) {
              viewType.value = format == CalendarFormat.month
                  ? CalendarViewType.month
                  : CalendarViewType.week;
            },
        ...
        if (!showListView && columnLabelType == ColumnLabelType.dropdown)
          buildCustomDropdown(
            context: context,
        ...
        if (!showListView &&
            columns.isNotEmpty &&
            (columnLabelType == ColumnLabelType.columnHeaders ||
                (showColumnHeadersInDropdownAllOption &&
                    selectedColumnId.value == 'all')))
          Row(
            children: [
                ...
                child: Row(
                  children: List.generate(
                    ...
                    (index) {
                      ...
                      final columnWidth =
                          (MediaQuery.of(context).size.width - timeLabelWidth) /
                              columns.length;
                      return SizedBox(
                        width: columnWidth,
                        child: Padding(
        ...
        // Event list and time labels or custom list builder
        Expanded(
          child: !showListView
              ? SingleChildScrollView(
                  ...
                  child: SizedBox(
                    height: (endHour - startHour) *
                        hourRowHeight, // duration of hours * height of each hour
                    child: Row(
                      children: [
                        SizedBox(
                        ...
                        Expanded(
                          child: EventList(
                            ...
                            scrollController: scrollController,
                            selectedDate: selectedDate.value,
                            columns: (columnLabelType ==
                                        ColumnLabelType.columnHeaders ||
                                    (showColumnHeadersInDropdownAllOption &&
                                        selectedColumnId.value == 'all'))
                                ? columns
                                : [],
              ...
              : (listBuilder != null
                  ? listBuilder!(context, filteredEvents, selectedDate.value)
                  : _buildDefaultListView(
                      context, filteredEvents, selectedDate.value)),
        ),
      ],
    );
  }

  /// Default list view when no listBuilder is provided
  Widget _buildDefaultListView(
      BuildContext context, List<CalendarEvent> events, DateTime selectedDate) {
  ...
  Widget build(BuildContext context) {
    final theme = Theme.of(context);
    final selectedDate = useState(this.selectedDate ?? DateTime.now());
    ...
    final dayDifference =
        CalendarDateUtils.getDayDifference(midnightToday, midnightSelected);
    ...
    final selectedColumnId =
        useState<String?>(columns.isNotEmpty ? 'all' : null);
    ...
    final filteredEvents = useMemoized(() {
      ...
      if (columns.isNotEmpty) {
        if (selectedColumnId.value != 'all') {
          result = EventUtils.filterEventsForColumn(
              selectedColumnId.value ?? columns.first.id, result);
        }
      }
      return result;
