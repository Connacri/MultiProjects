...
import 'demos/calendar_view_only_demo.dart';
import 'demos/compact_demo.dart';
import 'demos/custom_japanese_events_demo.dart';
import 'demos/custom_list_builder_demo.dart';
import 'demos/custom_turkish_events_demo.dart';
import 'demos/minimal_calendar_list_demo.dart';
import 'demos/minimal_demo.dart';
import 'demos/multi_column_demo.dart';
import 'demos/theme_demo.dart';
import 'demos/view_toggle_demo.dart';

class MyApp_calendar_planner_view extends StatelessWidget {
  const MyApp_calendar_planner_view({super.key});
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final listView = MediaQuery.of(context).size.width > 760 ||
    ...
    final demos = [
      (
        title: 'View Toggle Demo',
        description: 'Switch between timeline and list view modes',
        icon: Icons.swap_horiz,
        route: const ViewToggleDemo(),
      ),
      (
        title: 'Minimal Calendar List Demo',
        description: 'Simple calendar with basic event list',
        icon: Icons.event_note,
        route: const MinimalCalendarListDemo(),
      ),
      (
        title: 'Calendar View Only Demo',
        description: 'Clean calendar view with custom event cards',
        icon: Icons.view_agenda,
        route: const CalendarViewOnlyDemo(),
      ),
      (
        title: 'Custom List Builder Demo',
        description: 'Calendar with custom list builder for events display',
        icon: Icons.list,
        route: const CustomListBuilderDemo(),
      ),
      (
                      ...
                      children: [
                        FilledButton.icon(
                          onPressed: () => _launchUrl(
                              'https://pub.dev/packages/calendar_planner_view'),
                        ...
                        FilledButton.icon(
                          onPressed: () => _launchUrl(
                              'https://github.com/danial2026/calendar_planner_view'),
                ...
                : GridView.count(
                    ...
                    children: [
                      _DemoCard(
                        title: 'View Toggle Demo',
                        description:
                            'Switch between timeline and list view modes',
                        icon: Icons.swap_horiz,
                        onTap: () => Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const ViewToggleDemo()),
                        ),
                      ),
                      _DemoCard(
                        title: 'Minimal Calendar List Demo',
                        ...
                        onTap: () => Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) =>
                                  const MinimalCalendarListDemo()),
                        ),
                      ),
                      _DemoCard(
                        title: 'Calendar View Only Demo',
                        description:
                            'Clean calendar view with custom event cards',
                        icon: Icons.view_agenda,
                        onTap: () => Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) =>
                                  const CalendarViewOnlyDemo()),
                        ),
                      ),
                      _DemoCard(
                        title: 'Custom List Builder Demo',
                        description:
                            'Calendar with custom list builder for events display',
                        icon: Icons.list,
                        onTap: () => Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) =>
                                  const CustomListBuilderDemo()),
                        ),
                      ),
                      _DemoCard(
                        title: 'Custom Turkish Events Demo',
                        description:
                            'Calendar with custom event styling and interactions',
                        icon: Icons.event,
                        onTap: () => Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) =>
                                  const CustomTurkishEventsDemo()),
                        ),
                      ),
                      _DemoCard(
                        title: 'Custom Japanese Events Demo',
                        ...
                        onTap: () => Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) =>
                                  const CustomJapaneseEventsDemo()),
                        ),
                      ),
                      _DemoCard(
                        title: 'Basic Demo',
                        ...
                        onTap: () => Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const BasicDemo()),
                        ),
                      ),
                      _DemoCard(
                        title: 'Multi-Column Demo',
                        description:
                            'Calendar with multiple columns for different event types',
                        icon: Icons.view_column,
                        onTap: () => Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const MultiColumnDemo()),
                        ),
                      ),
                      _DemoCard(
                        title: 'Theme Demo',
                      ...
                      _DemoCard(
                        title: 'Compact Demo',
                        description:
                            'Compact calendar view with rounded events',
                        icon: Icons.view_compact,
                        onTap: () => Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const CompactDemo()),
                        ),
                      ),
                      _DemoCard(
                        title: 'Minimal Demo',
                        ...
                        onTap: () => Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const MinimalDemo()),
                        ),
                      ),
                    ],
                  ),
