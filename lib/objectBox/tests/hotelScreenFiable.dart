...
//
//     // Liste des chambres qui correspond aux roomName utilisés dans les réservations
...
// }
//
// class InfiniteDaysRow extends StatelessWidget {
//   final ScrollController controller;
//   final double dayWidth;
//   final DateTime referenceDate; // par ex. DateTime.now()
//
//   InfiniteDaysRow({
...
//   });
//
//   static const int totalItems = 1000000; // très grand nombre
//   static const int middleIndex = totalItems ~/ 2;
//
//   @override
//   Widget build(BuildContext context) {
...
//         final dayOffset = index - middleIndex;
...
//             mainAxisAlignment: MainAxisAlignment.center,
//             children: [
//               Text(_shortDayName(date.weekday),
//                   style: TextStyle(fontSize: 12, color: Colors.grey)),
//               SizedBox(height: 4),
