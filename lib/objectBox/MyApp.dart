  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(
          create: (_) =>
              AffectationJourProvider(AffectationJourRepository(
        ...
        ChangeNotifierProvider(
            create: (_) =>
                ActiviteHebdoProvider(
                    ActiviteHebdoRepository(
                        objectBox.store.box<ActiviteHebdo>()))),

        ChangeNotifierProvider(
          create: (_) => ImportProvider(objectBox.store),
        ),
        ChangeNotifierProvider(create: (_) =>
            GroupeTravailProvider(
